...
export const DEFAULT_EXTENDED_FIELD_MAPPING: ExtendedFieldMapping = {
  title: { enabled: true, notionPropertyName: 'Title', displayLabel: 'Event Title', propertyType: 'title', required: true },
  date: { enabled: true, notionPropertyName: 'Date', displayLabel: 'Event Date', propertyType: 'date', required: true },
  description: { enabled: true, notionPropertyName: 'Description', displayLabel: 'Description', propertyType: 'rich_text', required: false },
  location: { enabled: true, notionPropertyName: 'Location', displayLabel: 'Location', propertyType: 'rich_text', required: false },
  gcalEventId: { enabled: true, notionPropertyName: 'GCal Event ID', displayLabel: 'GCal Event ID', propertyType: 'rich_text', required: false },
  reminders: { enabled: false, notionPropertyName: 'Reminders', displayLabel: 'Reminder Minutes', propertyType: 'number', required: false },
  attendees: { enabled: false, notionPropertyName: 'Attendees', displayLabel: 'Attendees', propertyType: 'rich_text', required: false },
  organizer: { enabled: false, notionPropertyName: 'Organizer', displayLabel: 'Organizer', propertyType: 'rich_text', required: false },
  conferenceLink: { enabled: false, notionPropertyName: 'Conference Link', displayLabel: 'Conference Link', propertyType: 'rich_text', required: false },
  recurrence: { enabled: false, notionPropertyName: 'Recurrence', displayLabel: 'Recurrence', propertyType: 'rich_text', required: false },
  color: { enabled: false, notionPropertyName: 'Color', displayLabel: 'Calendar Color', propertyType: 'rich_text', required: false },
  visibility: { enabled: false, notionPropertyName: 'Visibility', displayLabel: 'Visibility', propertyType: 'rich_text', required: false },
};
