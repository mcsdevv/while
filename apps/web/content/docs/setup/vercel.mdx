...
<EnvVarsTable vars={[
  { name: "NEXTAUTH_SECRET", description: "Session encryption key", howToGet: <>Generate with <code>openssl rand -base64 32</code></> },
  ...
  { name: "AUTHORIZED_EMAILS", description: "Emails allowed to sign in", howToGet: <>Your email or pattern (e.g., <code>*@company.com</code>)</> },
  { name: "UPSTASH_REDIS_REST_URL", description: "Upstash Redis REST endpoint", howToGetLink: { href: "#add-redis-storage", label: "Add via Vercel Storage" } },
  { name: "UPSTASH_REDIS_REST_TOKEN", description: "Upstash Redis auth token", howToGetLink: { href: "#add-redis-storage", label: "Add via Vercel Storage" } },
]} />
...
<EnvVarsTable vars={[
  { name: "NEXTAUTH_URL", description: "App URL (auto-detected on Vercel)", default: "Auto" },
  { name: "SETTINGS_ENCRYPTION_KEY", description: "Credential encryption key", default: "None (recommended for production)" },
  { name: "AUTHORIZED_DOMAINS", description: "Domain allowlist (e.g., company.com)", default: "None" },
  { name: "SETUP_TOKEN", description: "One-time setup access token", default: "None" },
