...
<EnvVarsTable vars={[
  { name: "NEXTAUTH_SECRET", description: "Session encryption key", generate: "base64" },
...
<EnvVarsTable vars={[
  ...
  { name: "SETTINGS_ENCRYPTION_KEY", description: "Credential encryption key", generate: "base64", default: "None (recommended for production)" },
