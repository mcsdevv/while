...
[Go to **APIs & Services** > **OAuth consent screen**](https://console.cloud.google.com/auth/clients/create)
...
4. Add these [scopes](https://console.cloud.google.com/auth/scopes):
...
<EnvVarsTable vars={[
  { name: "GOOGLE_CLIENT_ID", description: "Your OAuth client ID" },
  { name: "GOOGLE_CLIENT_SECRET", description: "Your OAuth client secret" },
]} />
