...
| `GOOGLE_CLIENT_ID` | Google OAuth client ID | [Google OAuth Setup](/setup/google) |
| `GOOGLE_CLIENT_SECRET` | Google OAuth client secret | [Google OAuth Setup](/setup/google) |
| `NOTION_CLIENT_ID` | Notion OAuth client ID | [Notion Setup](/setup/notion) |
| `NOTION_CLIENT_SECRET` | Notion OAuth client secret | [Notion Setup](/setup/notion) |
